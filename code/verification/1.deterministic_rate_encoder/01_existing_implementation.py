...
def rateCodingDeterministicPix2Spike(pVal):
    ...
    return (spike_train, spike_emission_interval)


print("Spike train for pixel intensity value ", intesity)
print(rateCodingDeterministicPix2Spike(intesity)[0])

print("Spike emission interval for pixel intensity value ", intesity)
print(rateCodingDeterministicPix2Spike(intesity)[1])